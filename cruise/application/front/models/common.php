...
class Common extends CI_Model {
    ...
    function select_data_by_id($tablename, $columnname, $columnid, $data = '*',$contition_array = array(), $join_str = array()) {
       if($data!='*')
    ...
    // delete data
    function delete_data($tablename, $columnname, $columnid, $contition_array=array()) {
        $this->db->where($columnname, $columnid);
        $this->db->where($contition_array);
    ...
    //update login used for candidate and employer login both of in one login form it merge table of all user(here candidate and employer)
    function update_login($data, $tablename, $array=array()) {
        $this->db->where($array);
        if ($this->db->update($tablename, $data)) {
            return true;
        } else {
