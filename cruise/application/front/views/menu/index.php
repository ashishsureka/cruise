...
<?php echo $footer; ?>
		...
		$(function(rightcol){ // document ready
        ...
        var id=$(this).attr('id');
         ...
         $.ajax({
                ...
                success: function (result) { 
                    //alert(result);
                    var res = result.split("sepratediv");
                    console.log(res[0]);
                    if(result != 'false'){
                        $('.cart_error').css("display", "none");
                        $('#rightcol').html('');
                        $('#rightcol').append(res[0]);
                        if($('#rightcol2').css('display') == 'block') {
                            $('#rightcol2').html('');
                            $('#rightcol2').append(res[0]);
                        }
						
                         $('#footr_cart_div').append('');
                        $('#footr_cart_div').append(res[1]);
                    } else {
