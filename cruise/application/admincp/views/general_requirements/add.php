                     ...
                     <?php
                        ...
                        <div class="box-body">
                            <div class="form-group col-sm-10">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="requirement_title" id="requirement_title" placeholder="Requirement Title" maxlength="120">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-sm-10">
                                ...
                                <div class="col-sm-6">
                                    <textarea class="form-control" name="requirement_desc" id="requirement_desc" placeholder="Requirement Description" rows="5" maxlength="500"></textarea>
                                </div>
                            </div>                                                                                                             
