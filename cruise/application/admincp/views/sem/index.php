                            ...
                            <thead>
                             ...
                             <tbody>
                                <?php if (!empty($setting_list)) {
                                    ?>
                                <?php echo form_open('sem/mdelete', array('method' => 'post', 'id' => 'search_frm')); ?>
                                    <?php
                                //    pre($setting_list);
                                    foreach ($setting_list as $setting) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $setting['semfieldname'] ?></td>
                                            <td><?php echo $setting['semfieldvalue'] ?></td>
                                            
                                            <td>
                                                
                                                <?php $settingid=($setting['semid']); ?>
                                        <a href="#myModal" id="edit_btn" onclick="edit_setting('<?php echo $settingid; ?>');" data-toggle="modal" alt="Update" title="Update">
                                         <i class="fa fa-pencil"></i>
                                        </a>
                                                
                                                
<!--                                                <a href="<?php echo base_url() . 'setting/edit/' . $setting['semid']; ?>" id="edit_btn">
...
<script type="text/javascript">
   ...
   function edit_setting(id)
   {
       ...
       $('#model_data').html('');
       $.ajax({
          url:"<?php echo base_url('sem/editform'); ?>",
          type:"POST",
          dataType:"html",
          data:{'<?php echo $this->security->get_csrf_token_name(); ?>':'<?php echo $this->security->get_csrf_hash(); ?>','semid':setting_id,},
          catch:false,
