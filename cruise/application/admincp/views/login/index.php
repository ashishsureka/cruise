  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <!--<a href="<?php // echo base_url('index2.html')?>"><img src="<?php // echo base_url('images/logo.png')?>"/></a>-->
      </div><!-- /.login-logo -->
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
         <?php echo form_open('login/authenticate',array('name'=>'login_frm','id'=>'login_frm','method'=>'POST'));  ?>
