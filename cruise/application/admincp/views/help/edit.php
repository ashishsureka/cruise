        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <!-- form start -->
                     <?php
                        $form_attr = array('id' => 'edit_help_frm','enctype' => 'multipart/form-data');
                        echo form_open_multipart('help/edit', $form_attr);
                        ?>
                    <input type="hidden" name="help_id" id="help_id" value="<?php echo $help_detail[0]['help_id']; ?>" />
                        <div class="box-body">
                           
                                                        
                            <div class="form-group col-sm-10">
                                <label for="inputEmail3" class="col-sm-2 control-label">Help Title*</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="help_title" id="help_title" value="<?php echo $help_detail['0']['help_title'] ?>">
                            ...
                            <div class="form-group col-sm-10">
                                ...
                                <div class="col-sm-6">
                                    <?php echo form_textarea(array('name' =>'help_description','id'=>'help_description','class'=>"ckeditor",'value'=>$help_detail[0]['help_description'])); ?><br>
                                </div>
                            </div>
