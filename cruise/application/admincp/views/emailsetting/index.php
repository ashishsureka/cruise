                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: left;">
                                        <a class="text-white" href="<?php echo ( $this->uri->segment(3) == 'es_name' && $this->uri->segment(4) == 'ASC') ? site_url($this->uri->segment(1) . '/'.$segment2.'/es_name/DESC/' . $offset) : site_url($this->uri->segment(1) . '/'.$segment2.'/es_name/ASC/' . $offset); ?>" title=""> Title
                                        </a>
                                        <?php echo ( $this->uri->segment(3) == 'es_name' && $this->uri->segment(4) == 'ASC' ) ? '<i class="glyphicon glyphicon-arrow-up">' : (( $this->uri->segment(3) == 'es_name' && $this->uri->segment(4) == 'DESC' ) ? '<i class="glyphicon glyphicon-arrow-down">' : '' ); ?> 
                                    </th>
                                ...
                                //    pre($setting_list);
                                    foreach ($setting_list as $setting) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $setting['es_name'] ?></td>
                                            <td><?php echo $setting['es_value'] ?></td>
                                            
                                            <td>
                                                
                                                <?php $settingid=($setting['es_id']); ?>
...
<script type="text/javascript">
   ...
   function edit_setting(id)
   {
       ...
       $('#model_data').html('');
       $.ajax({
          url:"<?php echo base_url('emailsetting/editform'); ?>",
          type:"POST",
          dataType:"html",
          data:{'<?php echo $this->security->get_csrf_token_name(); ?>':'<?php echo $this->security->get_csrf_hash(); ?>','es_id':settingid,},
          catch:false,
