                ...
                <div class="box box-info">
                    ...
                    <!-- form start -->
                     <?php
                        ...
                        echo form_open_multipart('requirements/edit/', $form_attr);
                        ?>
                    <input type="hidden" name="module_id" id="module_id" value="<?php if(isset($requirement_detail[0]['prm_id'])){ echo $requirement_detail[0]['prm_id']; } ?>" />
