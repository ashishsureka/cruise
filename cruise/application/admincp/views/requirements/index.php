                                ...
                                <?php echo form_open('requirements/mdelete', array('method' => 'post', 'id' => 'search_frm')); ?>
                                    <?php foreach ($module_list as $module) { ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><a href="<?php echo site_url('requirements/comments/'.base64_encode($module['prm_id']).'/'.base64_encode($module['prr_id'])) ?>" alt="Comments" title="Comments"><i class="fa fa-comments-o" style=""></i></a> <?php echo comment_count($module['prr_id']) ?> </td>
                                            <td>
