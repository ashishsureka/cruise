                                    ...
                                    <div class="modal-body" id="sign_up">
                                        <div class="login text-center" id="detail">
                                            ...
                                            <div class="con_pro" >
                                                ...
                                                <button type="submit" class="btn fill_btn" data-dismiss="modal" onclick="$(\'#model_close_false\').val(\'1\');">Close</button>
                                            </div>
                                        </div>                                                
                                    </div>
                                </div>
